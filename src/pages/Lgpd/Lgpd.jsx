...
<p>Nosso site coleta e utiliza alguns dados pessoais seus, de forma a viabilizar a prestação de
serviços e aprimorar a experiência de uso.</p>

<p>1.1. Dados pessoais fornecidos pelo titular</p>
<p>Nome ou apelido (não sendo obrigado o uso do nome real), idade, cidade, estado, sexo, email.
Preferências e dados físicos (como altura por exemplo) podem ser solicitados mas não são
obrigatórios.</p>

<p>1.2. Dados pessoais coletados automaticamente</p>
<p>Seu ip de cadastro, seu ip de login, data de cadastro, data de login.</p>
...
completo e dados bancários para realizar a devida transferência bancária.</p><br />

<p><b>2. Como coletamos os seus dados?</b></p><br />
<p>Coletamos seus dados através de formulários de contato e softwares específicos que coletam
data e ip.</p>
...
impossibilidade da performance adequada de alguma funcionalidade do site que dependa da
...
meio eletrônico, seguro e idôneo. • Corrigir seus dados, ao solicitar a edição, correção ou
...
pesquisa, garantida, sempre que possível, a anonimização dos dados pessoais; III –
transferência a terceiro, desde que respeitados os requisitos de tratamento de dados
dispostos nesta Lei; ou IV – uso exclusivo do controlador, vedado seu acesso por terceiro, e
desde que anonimizados os dados. Isto é, informações pessoais sobre você que sejam
...
<p><b>6. O que fazemos para manter seus dados seguros?</b></p><br />
<p>Para mantermos suas informações pessoais seguras, usamos ferramentas físicas, eletrônicas e
gerenciais orientadas para a proteção da sua privacidade. Aplicamos essas ferramentas
levando em consideração a natureza dos dados pessoais coletados, o contexto e a finalidade
do tratamento e os riscos que eventuais violações gerariam para os direitos e liberdades do
...
terceiros ocorram, como ataques cibernéticos de hackers, ou também em decorrência da
negligência ou imprudência do próprio usuário/cliente. Em caso de incidentes de segurança
que possa gerar risco ou dano relevante para você ou qualquer um de nossos
usuários/clientes, comunicaremos aos afetados e a Autoridade Nacional de Proteção de Dados
...
a prestação dos serviços contratados e nossos contratos são orientados pelas normas de
proteção de dados do ordenamento jurídico brasileiro. Todavia, nossos parceiros têm suas
próprias Políticas de Privacidade, que podem divergir desta. Recomendamos a leitura desses
documentos. Além disso, também existem outras hipóteses em que seus dados poderão ser
...
<p><b>8. Alteração desta Política de Privacidade</b></p><br />
<p>Reservamos o direito de modificar essa Política de Privacidade a qualquer tempo,
principalmente em função da adequação a eventuais alterações feitas em nosso site ou em
âmbito legislativo. Recomendamos que você a revise com frequência. Eventuais alterações
entrarão em vigor a partir de sua publicação em nosso site e sempre lhe notificaremos acerca
das mudanças ocorridas. Ao utilizar nossos serviços e fornecer seus dados pessoais após tais
