    ...
    <div className="content-Login">
      ...
      <div className="EntrarConviteBrasil">
        ...
        <div className="title">
          ...
          <input type="email" placeholder="E-mail" value={email.replace(/\s+/g, '')} disabled/>
          {email.includes('@') ? "" :
                            <div className="alert">
        ...
        <h5>Seu e-mail contém letra maiúscula. Isso está certo?</h5>
          ...
          <input type="text" placeholder="patrono" value={patron} disabled/>
          <div className="titleInput">
          <p>Tipo de conta:</p>
          </div>
          <input type="text" placeholder="patrono" value={type} disabled/>
